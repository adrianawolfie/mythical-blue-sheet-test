...
(function () {
  ...
  window.openSpellPicker=async function(){await loadLibrary();const m=document.getElementById('spellPickerModal');if(!m)return;m.hidden=false;selectedSpellPreviewId='';renderSpellPreview();document.getElementById('spellPickerSearch')?.focus();renderPicker();};
